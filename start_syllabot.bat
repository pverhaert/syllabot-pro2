...
:: ============================================================
:: SyllaBot Pro² - User-Friendly Startup Script
:: ============================================================
title SyllaBot Pro² - Startup
...
:: ============================================================
echo %BLUE%[1/7] Checking working directory...%RESET%
...
:: ============================================================
echo %BLUE%[3/7] Checking Pandoc installation...%RESET%
...
:Step4
echo.
echo %BLUE%[4/7] Checking environment configuration...%RESET%
...
:: ============================================================
echo %BLUE%[5/7] Checking dependencies...%RESET%
...
:: ============================================================
:: STEP 6: Check Port Availability (Basic Check)
:: ============================================================
:CheckPorts
echo.
echo %BLUE%[6/7] Checking port availability...%RESET%
...
if not errorlevel 1 (
    echo %YELLOW%WARNING: Port %SERVER_PORT% appears to be in use%RESET%
    echo You may need to change SERVER_PORT in .env or close the conflicting application.
    echo [%date% %time%] WARNING: Port %SERVER_PORT% in use >> "%LOG_FILE%"
)

netstat -ano | findstr ":%CLIENT_PORT%" >nul 2>&1
if not errorlevel 1 (
    echo %YELLOW%WARNING: Port %CLIENT_PORT% appears to be in use%RESET%
    echo You may need to change CLIENT_PORT in .env or close the conflicting application.
    echo [%date% %time%] WARNING: Port %CLIENT_PORT% in use >> "%LOG_FILE%"
)
...
:: ============================================================
echo %BLUE%[7/7] Starting SyllaBot Pro^2...%RESET%
echo.
echo ========================================================
